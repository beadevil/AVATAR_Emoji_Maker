...
if st.button('CAMERA'):
    ...
    face_classifier = cv2.CascadeClassifier(r'https://github.com/beadevil/streamlit/haarcascade_frontalface_default.xml')
    classifier =load_model(r'https://github.com/beadevil/streamlit/model.h5')
