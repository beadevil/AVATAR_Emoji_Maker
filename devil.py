...
if st.button('CAMERA'):
    ...
    face_classifier = cv2.CascadeClassifier(github.com/beadevil/streamlit/haarcascade_frontalface_default.xml)
    classifier =load_model(github.com/beadevil/streamlit/streamlit/model.h5)
